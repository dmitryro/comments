...
const basePlugins = [
    ...
    new CheckerPlugin(),
    new HtmlWebpackPlugin({template: 'build/tpl/index.html',}),
    new webpack.HotModuleReplacementPlugin(), // enable HMR globally
    new webpack.NamedModulesPlugin(), // prints more readable module names inthe browser console on HMR updates
